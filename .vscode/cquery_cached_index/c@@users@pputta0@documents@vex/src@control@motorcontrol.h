...
//Motor general
#define MOTOR_NUM               8      //Used to be kNumbOfTotalMotors, changed for now because
 ...
 */
pros::Motor* addMotor(const int index, float slewRate = MOTOR_DEFAULT_SLEW_RATE);
