...
void heap_PrintStats(const unsigned int loc, const unsigned int size)
{
  ...
  printf("BCI HEAP STATS:");
  printf("Percent used: %1.2f, Used space: %d, Free space: %d", 100 * ((float)(size - freeSpace) / (float)size), size - freeSpace, freeSpace);
}
